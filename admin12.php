...
<head>
    ...
    <title>Grade-12 Admin Dashboard</title>
...
<body>
    <div class="container">
        ...
        <h2>Grade-12 Admin Dashboard</h2>
        <div class="grade-links">
            ...
            <?php foreach (['Bio Science', 'Physical Science', 'E-Tech', 'Bio Tech', 'Commerce', 'Arts'] as $stream): ?>
                <div class="grade-link">
                    <a href="admin_grade_12_<?php echo strtolower(str_replace(' ', '_', $stream)); ?>.php">Grade 12 <?php echo $stream; ?></a>
                </div>
            <?php endforeach; ?>
        </div>
